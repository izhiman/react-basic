...
if ("development" !== 'production') {
  ...
  if (ExecutionEnvironment.canUseDOM && window.top === window.self) {
    ...
    "development" !== 'production' ? warning((testFunc.name || testFunc.toString()).indexOf('testFn') !== -1, 'It looks like you\'re using a minified copy of the development jslib ' + 'of React. When deploying React apps to production, make sure to use ' + 'the production jslib which skips development warnings and is faster. ' + 'See https://fb.me/react-minification for more details.') : void 0;
...
function handleTopLevelImpl(bookKeeping) {
  ...
  // It's important that we jslib the array of ancestors before calling any
...
/**
 * Allows extraction of a minified key. Let's the jslib system minify keys
